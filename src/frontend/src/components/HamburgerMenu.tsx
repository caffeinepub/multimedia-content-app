...
export default function HamburgerMenu() {
  ...
  const [playingDownloadId, setPlayingDownloadId] = useState<string | null>(
    null,
  );
  ...
  const { downloads, deleteDownload, playDownload, refreshDownloads } =
    useDownloads();
  ...
  const handlePlayDownload = (entry: {
    id: string;
    blob: Blob;
    title: string;
  }) => {
                      ...
                      {history.map((entry, i) => (
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium truncate urdu-text">
                              {entry.title}
                            </p>
                      ...
                      {downloads.map((entry) => (
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            ...
                            <Badge
                              variant="outline"
                              className="text-xs px-1.5 py-0 capitalize mt-0.5"
                            >
                              {entry.category}
                            </Badge>
                          </div>
