...
export default function UsersControlsPanel() {
  ...
  const [localMaintenance, setLocalMaintenance] = useState<boolean | null>(
    null,
  );
  ...
  const effectiveMaintenance =
    localMaintenance !== null ? localMaintenance : maintenanceMode;
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="text-sm text-destructive font-medium text-center px-4">
          Admin access unavailable. Please reload the page and enter your PIN
          again.
        </p>
        <Button
          variant="outline"
    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="bg-card border border-border rounded-2xl p-5">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          When enabled, all users will see a maintenance screen instead of the
          app.
        </p>
        {maintenanceLoading ? (
